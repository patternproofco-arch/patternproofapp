-- One preserved source may support more than one survivor-reviewed journal
-- entry. Keep evidence.linked_incident_id as the legacy primary link while
-- this junction table records every confirmed relationship.
...
-- Preserve every existing primary link.
