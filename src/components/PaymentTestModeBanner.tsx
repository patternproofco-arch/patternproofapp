...
export function PaymentTestModeBanner() {
  if (!clientToken) {
    return (
      <div
        ...
        style={{
          background: "rgba(231,123,86,0.35)",
          borderColor: "rgba(231,123,86,0.5)",
          color: "var(--pp-urgent)",
        }}
      >
  ...
  if (clientToken.startsWith("pk_test_")) {
    return (
      ...
      >
        All payments made in preview are in test mode. Use card 4242 4242 4242 4242 with any future
        expiry & CVC.
      </div>
    );
  }
