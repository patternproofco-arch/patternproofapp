...
/**
 * Per-persona colorway for the mark. Each variant uses one restrained solid
 * accent so the logo sits quietly on the shared neutral material.
 */
...
export const MARK_COLORWAYS: Record<Exclude<MarkVariant, "neutral">, MarkColorway> = {
  survivor: { kind: "solid", solid: "#7188F0" },
  attorney: { kind: "solid", solid: "#5F7896" },
  advocate: { kind: "solid", solid: "#71836C" },
};
...
/**
 * The PatternProof mark: a folded "P" ribbon. One geometry and three
 * restrained solid portal colorways keep the mark consistent across the app.
 */
