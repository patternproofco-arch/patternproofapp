  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: 13.5, color: "#3A3849", lineHeight: 1.55, marginBottom: 14 }}>
        Take screenshots as you scroll — a little overlap between them is fine, we&apos;ll stitch
      ...
      <div className="grid grid-cols-2 gap-3 mb-3">
        ...
        <div>
          ...
          <input
            ...
            className="input-pp mt-1"
            placeholder="e.g. from March, before the hearing"
          />
        </div>
      </div>
      ...
      <div className="mt-5 flex items-center justify-end gap-2">
        ...
        >
          ...
          {busy
            ? "Stitching…"
            : `Stitch ${shots.length} screenshot${shots.length === 1 ? "" : "s"}`}
        </button>
      </div>
    </div>
  );
