  ...
  return (
    ...
    >
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <h1 style={{ fontFamily: "'Newsreader', Georgia, serif", fontSize: 40, lineHeight: 1.15, margin: "8px 0 12px", fontWeight: 500 }}>{title}</h1>
...
export function Section({ title, children }: { title: string; children: ReactNode }) {
  return (
    <section>
      <h2 style={{ fontFamily: "'Newsreader', Georgia, serif", fontSize: 22, margin: "0 0 10px", fontWeight: 500 }}>{title}</h2>
