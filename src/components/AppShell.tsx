...
export function AppShell() {
  ...
  return (
    <div className="min-h-screen w-full" style={{ background: "var(--background)" }}>
      {/* Desktop sidebar */}
      <aside
        className="no-print fixed left-0 top-0 hidden h-screen w-[210px] flex-col md:flex"
      ...
      {/* Mobile bottom nav */}
      <nav
        className="no-print fixed bottom-0 left-0 right-0 z-40 flex justify-around border-t md:hidden"
