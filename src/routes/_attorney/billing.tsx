...
const TIERS: Array<{ key: TierKey; name: string; price: string; priceStrike?: string; per: string; priceId: string; bullets: string[]; recommended?: boolean }> = [
  ...
  },
  {
    ...
    recommended: true,
    bullets: ["Up to 15 attorney seats", "Unlimited active client matters", "Multi-attorney collaboration and shared case notes", "Conflict-of-interest check across your firm's PatternProof caseload", "Charter rate locked 12 months, then $897/mo"],
  },
  {
    key: "firm",
    name: "Firm",
    ...
    bullets: ["Up to 15 attorney seats", "Unlimited active client matters", "Multi-attorney collaboration and shared case notes", "Conflict-of-interest check across your firm's PatternProof caseload", "Priority client onboarding support"],
  },
];
