      ...
      <div className="pp-legal-sheet">
        ...
        <main>
          ...
          <section className="pp-legal-prose">
            ...
            <p>
              PatternProof is a documentation and evidence-organization tool. It is{" "}
              <strong>not a law firm</strong>, does not provide legal advice, and does not create an
              attorney-client relationship. AI outputs (patterns, summaries, drafts) are
              informational and may contain errors — always verify before relying on them in legal
              proceedings.
            </p>

            <H2>3. Your account</H2>
            <p>
              You must be 18+ (or the age of majority in your jurisdiction) to use the service. You
              are responsible for keeping your credentials secure. Do not share your account.
            </p>

            <H2>4. Your content, your ownership</H2>
            <p>
              Everything you upload, write, or record on PatternProof belongs to you. You grant us a
              limited license only to store, process, and display it back to you (and to people you
              explicitly grant access to) in order to provide the service. We will not sell your
              data, ever.
            </p>
            ...
            <ul>
              <li>
                Do not use the service to harass, threaten, or fabricate evidence about another
                person.
              </li>
            ...
            <p>
              Recording laws vary by state and country. You are solely responsible for complying
              with the laws that apply where you and the other party are located. PatternProof
              surfaces reminders where practical but cannot verify compliance for you.
            </p>

            <H2>7. Attorney &amp; organization users</H2>
            <p>
              Attorneys and organizations who access survivor data through PatternProof act as
              independent professionals bound by their own ethical and legal duties. PatternProof
              does not supervise their practice and is not responsible for their handling of
              matters.
            </p>

            <H2>8. Payments</H2>
            <p>
              Paid plans are billed through Stripe. You can cancel any time; access continues
              through the end of the paid period. We do not offer refunds for partial periods except
              where required by law.
            </p>

            <H2>9. Availability &amp; changes</H2>
            <p>
              We aim for high availability but do not guarantee uninterrupted service. We may add,
              change, or remove features. Material changes to these Terms will be posted here with a
            ...
            <p>
              ...
              grace@gburnscompany.com (an automated in-app delete flow is not yet available). We may
              suspend or terminate accounts that violate these Terms or create legal or safety risk.
              On termination, we will delete your data per our Privacy Policy retention rules.
            </p>

            <H2>11. Disclaimers, Limitation of Liability &amp; Indemnification</H2>
            <p>
              The service is provided "as is" without warranties of any kind. To the maximum extent
              permitted by law, PatternProof's total liability for any claim relating to the service
            ...
            <p>
              ...
              rights; or (c) your violation of any law, including recording-consent laws, in
            ...
            <p>
              ...
              <a href="mailto:grace@gburnscompany.com" className="pp-legal-link">
