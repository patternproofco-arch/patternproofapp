  ...
  head: () => ({
    meta: [
      { title: "Privacy Policy — PatternProof" },
      {
        name: "description",
        content:
          "How PatternProof collects, uses, stores, and protects your information. Privacy-by-design documentation platform for survivors of domestic violence and coercive control.",
      },
      { property: "og:title", content: "Privacy Policy — PatternProof" },
      {
        property: "og:description",
        content:
          "Privacy-by-design protections for survivors. Read how PatternProof handles your documentation, AI processing, and data sharing.",
      },
    ...
    <div data-persona="survivor" className="pp-legal-shell">
      ...
      <div className="pp-legal-sheet">
        <nav className="pp-legal-nav" aria-label="Legal document navigation">
          ...
          <Link to="/pricing" className="pp-legal-link">
            Pricing
          </Link>
        </nav>
        ...
        <Prose>
          ...
          <p>
            Given the sensitive nature of our platform — designed to support survivors of domestic
            violence, coercive control, and post-separation abuse — we apply privacy-by-design
            principles that exceed minimum legal requirements.
          </p>
          <p>By using our Services, you agree to the terms of this Privacy Policy.</p>

          <H2>1. Who We Are</H2>
          <p>
            PatternProof is a documentation and pattern analysis platform built for survivors of
            domestic violence, coercive control, and post-separation abuse, and the attorneys and
            advocates who support them.
          </p>
          <ul>
            <li>
              <strong>Company:</strong> PatternProof
            </li>
            <li>
              <strong>Founder:</strong> Grace Burns
            </li>
            <li>
              <strong>Contact:</strong> grace@gburnscompany.com
            </li>
            <li>
              <strong>Location:</strong> New Jersey, United States
            </li>
          </ul>
          ...
          <p>
            ...
            management software), we may receive information from that service as authorized by you.
            We only request access to the data necessary for the integration to function.
          </p>
          ...
          <ul>
            ...
            <li>
              Generate timelines, pattern groupings, and summaries for professional review from your
              documentation
            </li>
          ...
          <p>
            We do not sell your personal information. We do not use your documentation content to
            train AI models.
          </p>
          ...
          <p>
            ...
            marketing purposes. We may share information in the following limited circumstances:
          </p>
          <H3>With Your Authorized Attorney</H3>
          <p>
            If you choose to share your case file or export materials to an attorney through the
            platform, that attorney will receive the information you designate. You control what is
            shared.
          </p>
          <H3>With Third-Party Integrations</H3>
          <p>
            If you authorize integration with a third-party legal platform, we will share only the
            information necessary for that integration to function, as directed by you.
          </p>
          <H3>Service Providers</H3>
          <p>
            We work with trusted third-party service providers who help us operate the platform,
            including hosting, database, and AI processing providers. These providers are bound by
            terms that restrict use of your data to providing services to us. Current sub-processors
            include:
          </p>
          <ul>
            <li>
              <strong>Lovable</strong> — application hosting, infrastructure, and AI Gateway (routes
            ...
            <li>
              <strong>Google Calendar / Google Drive</strong> — only if you choose to connect these
              integrations. Used to sync court dates or import files you select. Disconnect anytime;
              we stop syncing immediately.
            </li>
            <li>
          ...
          <p>
            We may disclose information if required by law, court order, or to protect the safety of
            our users or others. We will notify you of any such request if legally permitted to do
            so.
          </p>
          ...
          <ul>
            ...
            <li>
              At-rest encryption is provided by our infrastructure hosts (managed Postgres and
              object storage) as a platform feature. We rely on their published controls and have
              not independently audited or certified that configuration.
            </li>
          ...
          <p style={{ fontSize: 13, color: "var(--muted-foreground)" }}>
            ...
            where PatternProof staff cannot technically read your data. We will clearly announce
            this capability if and when we ship it. Until then, please assume authorized
            PatternProof engineers can technically access account contents in order to operate and
            support the service.
          </p>
          <p>
            No system is 100% secure. If you believe your account has been compromised, contact us
            immediately at grace@gburnscompany.com.
          </p>
          ...
          <H3>Deletion</H3>
          <p>
            Automated in-app account deletion is not yet available. To request deletion of your
            account and associated data, email grace@gburnscompany.com with the subject line "Data
            Deletion Request." We aim to process requests within a reasonable time and will confirm
            when the deletion is complete. Until we can offer an automated deletion flow, this
            manual request process is the only supported method.
          </p>
          <H3>Data Export</H3>
          <p>
          ...
          <p>
            ...
            request deletion of their data, and opt out of the sale of personal information. We do
            not sell personal information. To exercise your rights, contact grace@gburnscompany.com.
          </p>
          <H3>Opt Out of Communications</H3>
          <p>
            You may opt out of non-essential communications at any time by contacting us or using
            the unsubscribe link in any email.
          </p>

          <H2>8. Data Retention</H2>
          <p>
            We retain your account and documentation data for as long as your account is active or
            as needed to provide the Services. When you email us a deletion request (see "Deletion"
            above), we will remove your data as promptly as our current manual process allows,
          ...
          <p>
            ...
            documentation tool designed to support adult survivors navigating family court, custody,
            and domestic violence proceedings. We do not knowingly collect personal information from
            anyone under the age of 18. If we learn we have collected information from a minor, we
            will delete it immediately. If you believe we may have inadvertently collected
            information from someone under 18, please contact us at grace@gburnscompany.com.
          </p>

          <H2>10. Third-Party Links</H2>
          <p>
            Our Services may contain links to third-party websites or services. We are not
            responsible for the privacy practices of those third parties and encourage you to review
...
function Prose({ children }: { children: React.ReactNode }) {
  return <div className="pp-legal-prose">{children}</div>;
}
