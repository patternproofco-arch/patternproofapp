  ...
  const firm: Tier = charterFull
    ? {
        ...
        features: [
          ...
          "Conflict-of-interest check across your firm's PatternProof caseload",
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Firm gives you up to 15 attorney seats in one shared workspace, unlimited active matters, multi-attorney collaboration, a caseload view across the firm, and a conflict-of-interest check across the caseload your firm has in PatternProof. Solo is a single-attorney seat capped at 10 matters.",
  },
  {
