...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Private documentation for survivors of domestic abuse and high-conflict custody cases. Encrypted in transit and at rest." },
      ...
      { property: "og:description", content: "Private documentation for survivors of domestic abuse and high-conflict custody cases. Encrypted in transit and at rest." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "PatternProof — Private documentation for your case" },
      { name: "twitter:description", content: "Private documentation for survivors of domestic abuse and high-conflict custody cases. Encrypted in transit and at rest." },
          ...
          "@graph": [
            {
              ...
              description: "Private documentation for survivors of domestic abuse and high-conflict custody cases. Encrypted in transit and at rest.",
            },
            {
              "@type": "WebSite",
              ...
              name: "PatternProof",
              url: "https://project--f496a23a-1a8f-408f-b5e0-e96d5947d49c.lovable.app/",
              description: "Private documentation for your case, encrypted in transit and at rest. Visible only to you and anyone you choose to share it with.",
