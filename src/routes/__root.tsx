...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "P4TTERN PR00F — Private documentation for your case" },
      { name: "description", content: "Private, encrypted documentation for survivors of domestic abuse and high-conflict custody cases." },
      { property: "og:site_name", content: "P4TTERN PR00F" },
      { property: "og:type", content: "website" },
      { property: "og:title", content: "P4TTERN PR00F — Private documentation for your case" },
      ...
      { name: "twitter:title", content: "P4TTERN PR00F — Private documentation for your case" },
      ...
      { name: "twitter:site", content: "@P4TTERN PR00F" },
