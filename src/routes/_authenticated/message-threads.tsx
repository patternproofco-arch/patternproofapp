    ...
    <div className="flex flex-col gap-8">
      ...
      {tier === "tier2" && (
        ...
        >
          ...
          >
            <StepCard
              n="1"
              title="iPhone (Finder or iTunes)"
              body="Connect your iPhone to a Mac or PC. Use Finder (macOS) or iTunes (Windows) to make an encrypted local backup. Then use a reputable tool like iMazing or Decipher TextMessage to export your messages as a PDF, CSV, or TXT file."
            />
            <StepCard
              n="2"
              title="Android (Google Takeout or backup app)"
              body="Sign in to Google Takeout on a computer and export SMS/Chats — or use a reputable Android backup app that produces an export file. Save the export somewhere you can find it."
            />
            <StepCard
              n="3"
              title="Upload the export below"
          ...
          <div className="grid gap-3" style={{ gridTemplateColumns: "1fr 1fr" }}>
            ...
            <div>
              ...
              <input
                ...
                className="input-pp mt-1"
                placeholder="e.g. iPhone, Finder backup, laptop present"
              />
            </div>
          </div>
      ...
      <section className="flex flex-col gap-4">
        ...
        {threads.length === 0 ? (
          ...
          >
            Nothing here yet. When you&apos;re ready, upload an export above — your file stays
            private to you.
          </div>
        ) : (
    ...
    >
      {captureLabel && (
        ...
        >
          ...
          {t.captured_at && (
            <span style={{ opacity: 0.7 }}> · {new Date(t.captured_at).toLocaleString()}</span>
          )}
        </div>
      )}
      ...
      <header className="flex items-start justify-between gap-3 mb-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            >
              {t.source_type.toUpperCase()} · {new Date(t.created_at).toLocaleDateString()} ·{" "}
