...
export const Route = createFileRoute("/_authenticated/professional-review")({
      ...
      <div className="card-pp">
        ...
        <div style={{ boxShadow: "var(--pp-shadow-sm)", borderRadius: 18, overflow: "hidden" }}>
          <StripeEmbeddedCheckout
            ...
            returnUrl={`${typeof window !== "undefined" ? window.location.origin : ""}/professional-review-thanks?session_id={CHECKOUT_SESSION_ID}`}
          />
        </div>
      </div>
    </div>
