...
export default defineTool({
  ...
  inputSchema: {
    limit: z.number().int().min(1).max(100).optional().describe("Maximum incidents to return (default 25)."),
    since: z.string().optional().describe("Optional ISO date (YYYY-MM-DD). Only incidents on or after this date."),
  },
